                      ...
                      itemBuilder: (context, bindex) {
                        return Padding(
                          ...
                          child: Row(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              chatstate.chatRoomStates[videoId]!.messages[bindex].userImage==""?CircleAvatar(backgroundImage: AssetImage("assets/img/profile3_s.png"),):
                              Container(height: 30.h,child: CircleAvatar(backgroundImage: NetworkImage(chatstate.chatRoomStates[videoId]!.messages[bindex].userImage,),)),
                              SizedBox(width: 5,),
                              Column(
                                ...
                                children: [
                                  ...
                                  Text( chatstate.chatRoomStates[videoId]!.messages[bindex].text,style: TextStyle(fontSize: 16.sp,fontWeight: FontWeight.w100),),
                                  Builder(
                                    builder: (context) {
                                        String showTime;
